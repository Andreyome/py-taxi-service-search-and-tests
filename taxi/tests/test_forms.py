...
from taxi.forms import DriverLicenseUpdateForm, CarSearchForm, ManufacturerSearchForm, DriverSearchForm
from taxi.models import Manufacturer, Car, Driver
from taxi.tests.tests_views import CAR_LIST_URL, MANUFACTURER_LIST_URL, DRIVER_LIST_URL
...
class SearchTests(TestCase):
    ...
    def test_search_cars_by_model(self):
        ...
        unfiltered_car = Car.objects.create(
            manufacturer=manufacturer,
            model="Random model",
        )
    ...
    def test_manufacturer_search_by_name(self):
        ...
        manufacturer = Manufacturer.objects.create(name="Test Manufacturer")
        manufacturer1 = Manufacturer.objects.create(name="Test Another Manufacturer")
        manufacturer2 = Manufacturer.objects.create(name="Random name")
        res = self.client.get(MANUFACTURER_LIST_URL, {"name": "Test", "page":1})
        self.assertEqual(res.status_code, 200)
